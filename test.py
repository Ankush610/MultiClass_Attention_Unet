...
if __name__ == "__main__":
    ...
    dataset_path = "/home/omjadhav/ankush/medical_project/Multiclass-Segmentation-in-PyTorch/dataset/avseg"
    colormap = [
        [0, 0, 0],        # 0: Background
        [255, 0, 0],      # 1: Artery
        [0, 0, 255],      # 2: Vein
    ...
    classes = ["background", "artery", "vein", "junction", "uncertain"]
    ...
    if "model_state_dict" in checkpoint:  # training script saved dict
        model.load_state_dict(checkpoint["model_state_dict"])
    else:  # model saved directly
